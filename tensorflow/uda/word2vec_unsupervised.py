#!/usr/bin/env python
# -*- coding: utf-8 -*-
# FileName  : word2vec_unsupervised.py
# Author    : wuqingfeng@
    ...
    with tf.Session(graph=graph) as session:
        ...
        for step in range(num_steps):
            ...
            if step % 2000 == 0:
                ...
                print('Average loss at step %dL %f' % (step, average_loss))
                average_loss = 0
            if step % 10000 == 0:
                sim = similarity.eval()
...
if __name__ == "__main__":
    ...
    words = read_data("/opt/download/text8.zip")
    ...
    embeddings = train_with_word2vec()
